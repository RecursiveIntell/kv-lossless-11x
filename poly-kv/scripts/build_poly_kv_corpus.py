#!/usr/bin/env python3
"""
build_poly_kv_corpus.py — convert a HuggingFace DynamicCache to a
poly-kv-compatible JSON corpus.

The poly-kv HuggingFace roundtrip CLI
(`poly_kv_dynamic_cache_roundtrip`) takes a JSON file in this shape:
...
Usage:
    python scripts/build_poly_kv_corpus.py \
        --cache cache_oracle.pt \
        --output poly_kv_corpus.json
"""
import argparse
import json
import sys
